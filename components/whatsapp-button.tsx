...
export default function WhatsAppButton() {
  ...
  const handleWhatsAppClick = (e: React.MouseEvent) => {
    ...
    try {
      ...
      window.location.href = `https://wa.me/50687467602`
    }
  }
  ...
  return (
    <motion.button
      ...
      whileTap={{ scale: 0.95 }}
      className="z-50 w-14 h-14 bg-black hover:bg-gray-800 text-white rounded-full shadow-lg hover:shadow-xl transition-all duration-300 flex items-center justify-center group cursor-pointer"
    ...
    >
      <svg
        className="w-7 h-7 group-hover:scale-110 transition-transform duration-200 pointer-events-none"
        viewBox="0 0 24 24"
        fill="currentColor"
      >
      ...
      <div className="absolute inset-0 rounded-full bg-black animate-ping opacity-20 pointer-events-none" />
    </motion.button>
  )
}
